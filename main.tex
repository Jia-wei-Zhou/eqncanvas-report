...
input and keyboard input. MUI component \code{Switch} is used as the toggle. The toggle controls a state variable \code{useHandwrite}. When the toggle is on, \code{useHandwrite} equals false, vice versa.
...
attribute \code{open} to control the state of the handwriting input dialog.
